...
arp_service_list <- lapply(service_data2.2$sheet_name, function(service) {
  data_wide <- data.table(read.xlsx("data-raw/src data/phase 2.2 data/Monthly Data Submissions P2.2 Collation to 2017-01-30 AMALGAMATED - 2017.02.22.xlsx", sheet = service, rows = 3:256, colNames = FALSE, skipEmptyRows = TRUE))
